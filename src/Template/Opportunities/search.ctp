                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="search-jobs">
                                        <input type="text" name="job_query" value="<?php echo $query_search; ?>" placeholder="Job Search">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="search-job-location">
                                        <select name="job_location">
                                          ...
                                          <?php foreach( $states as $key => $value ){ ?>
                                            <option <?php echo( $key == $query_job_location ? 'selected="selected"' : '' ); ?> value="<?php echo $key; ?>"><?php echo $value ?></option>
                                          <?php } ?>
                                        </select>
                                    </div>
                                </div>
