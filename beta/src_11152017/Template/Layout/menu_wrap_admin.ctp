    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        ...
        <li id="users_nav" title="Users" class="<?= $nav_selected["blog_categories"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Blog Categories") . "</span>",["controller" => "blog_categories", "action" => "index"],["escape" => false]) ?>
        </li>    
        <li id="users_nav" title="Users" class="<?= $nav_selected["countries"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Countries") . "</span>",["controller" => "countries", "action" => "index"],["escape" => false]) ?>
        </li>    
        <li id="users_nav" title="Users" class="<?= $nav_selected["states"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("States") . "</span>",["controller" => "states", "action" => "index"],["escape" => false]) ?>
        </li>    
        <li id="users_nav" title="Users" class="<?= $nav_selected["opportunity_types"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Job Classifications") . "</span>",["controller" => "opportunity_types", "action" => "index"],["escape" => false]) ?>
        </li>            
        <li id="users_nav" title="Users" class="<?= $nav_selected["work_types"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Work Types") . "</span>",["controller" => "work_types", "action" => "index"],["escape" => false]) ?>
        </li> 
        <li id="users_nav" title="Users" class="<?= $nav_selected["job_roles"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Job Roles") . "</span>",["controller" => "job_roles", "action" => "index"],["escape" => false]) ?>
        </li>            
        <li id="users_nav" title="Users" class="<?= $nav_selected["salary_types"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Salary Types") . "</span>",["controller" => "salary_types", "action" => "index"],["escape" => false]) ?>
        </li>            
        <li id="users_nav" title="Users" class="<?= $nav_selected["industry_groups"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Industry Groups") . "</span>",["controller" => "industry_groups", "action" => "index"],["escape" => false]) ?>
        </li>     
        <li id="users_nav" title="Users" class="<?= $nav_selected["groups"] ?>">
            <?= $this->Html->link('<i class="fa fa-gear"></i><span>' . __("Groups") . "</span>",["controller" => "groups", "action" => "index"],["escape" => false]) ?>
        </li>  
